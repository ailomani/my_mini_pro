...
else
{
	...
	// get customer 
	$result1 = mysql_query("INSERT INTO user_health_info (email,field_1,field_2,field_3,field_4,field_5)
			VALUES('$get_email','$get_field_1',  '$get_field_2', '$get_field_3', '$get_field_4','$get_field_5')");
